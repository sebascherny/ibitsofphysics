...
urlpatterns = [
    ...
    path('subscribe-1-year/', views.redirect_to_stripe_1_year, name='redirect_to_stripe_1_year'),
    path('subscribe-2-years/', views.redirect_to_stripe_2_years, name='redirect_to_stripe_2_years'),
