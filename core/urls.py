...
urlpatterns = [
    ...
    path('notes/', views.chapter_resource_view, {'category': 'notes'}, name='notes'),
    path('notas/', views.chapter_resource_view, {'category': 'notas'}, name='notas'),
    path('practices/', views.chapter_resource_view, {'category': 'practices'}, name='practices'),
    path('practicas/', views.chapter_resource_view, {'category': 'practicas'}, name='practicas'),
    path('notes-and-practices/', views.chapter_resource_view, {'category': 'notes_and_practices'}, name='notes_and_practices'),
    path('notas-y-practicas/', views.chapter_resource_view, {'category': 'notas_y_practicas'}, name='notas_y_practicas'),
